        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-6 pb-12">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <ul className="space-y-2.5 text-xs text-[#475569]">
              ...
              <li>
                <button
                  onClick={() => handleServiceClick("content-video")}
                  className="flex items-center gap-2.5 hover:text-[#B8860B] transition-colors text-left cursor-pointer"
                >
                  <Video className="w-4 h-4 text-[#B8860B]" />
                  <span>Content & Video Production</span>
                </button>
              </li>
              <li>
                <a href="/services/seo" className="flex items-center gap-2.5 hover:text-[#B8860B] transition-colors">
                  <Search className="w-4 h-4 text-[#B8860B]" />
                  <span>SEO Services</span>
                </a>
              </li>
              <li>
                <a href="/services/digital-marketing" className="flex items-center gap-2.5 hover:text-[#B8860B] transition-colors">
                  <Compass className="w-4 h-4 text-[#B8860B]" />
                  <span>Digital Marketing</span>
                </a>
              </li>
              <li>
                <a href="/services/google-ads" className="flex items-center gap-2.5 hover:text-[#B8860B] transition-colors">
                  <Megaphone className="w-4 h-4 text-[#B8860B]" />
                  <span>Google Ads / PPC</span>
                </a>
              </li>
              <li>
                <a href="/services/web-development" className="flex items-center gap-2.5 hover:text-[#B8860B] transition-colors">
                  <Code2 className="w-4 h-4 text-[#B8860B]" />
                  <span>Web Development</span>
                </a>
              </li>
              <li>
                <a href="/services/social-media-marketing" className="flex items-center gap-2.5 hover:text-[#B8860B] transition-colors">
                  <Share2 className="w-4 h-4 text-[#B8860B]" />
                  <span>Social Media Marketing</span>
                </a>
              </li>
              <li>
                <a href="/services/shopify-development" className="flex items-center gap-2.5 hover:text-[#B8860B] transition-colors">
                  <ShoppingCart className="w-4 h-4 text-[#B8860B]" />
              ...
              <li>
                <button
                  onClick={() => handleServiceClick("areas-we-serve")}
                  className="flex items-center gap-2.5 hover:text-[#B8860B] transition-colors text-left cursor-pointer"
                >
                  <MapPin className="w-4 h-4 text-[#B8860B]" />
                  <span>Areas We Serve (Pan-India)</span>
                </button>
              </li>
            </ul>
          </div>
